...
dphi_top_bjet = Quantity("DNN_dphi_top_bjet")
deta_top_sb = Quantity("DNN_deta_top_sb")
dphi_bjet1_bjet2 = Quantity("DNN_dphi_bjet1_bjet2")
deta_lep_bjet1 = Quantity("DNN_deta_lep_bjet1")
m_lep_bjet2 = Quantity("DNN_m_lep_bjet2")
pt_bjet1_bjet2 = Quantity("DNN_pt_bjet1_bjet2")
costhetastar = Quantity("DNN_costhetastar")
sumht = Quantity("DNN_sumht")
wolfram = Quantity("DNN_wolfram")
deta_topbjet2_bjet1 = Quantity("DNN_deta_topbjet2_bjet1")
