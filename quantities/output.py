...
mu_pt = Quantity("Nano_Muon_pt")
mu_eta = Quantity("Nano_Muon_eta")
mu_phi = Quantity("Nano_Muon_phi")
mu_mass = Quantity("Nano_Muon_mass")
mu_iso = Quantity("Nano_Muon_pfRelIso04_all")
mu_miniiso = Quantity("Nano_Muon_miniPFRelIso_all")
mu_tightid = Quantity("Nano_Muon_tightId")
el_pt = Quantity("Nano_Electron_pt")
el_eta = Quantity("Nano_Electron_eta")
el_phi = Quantity("Nano_Electron_phi")
el_mass = Quantity("Nano_Electron_mass")
el_detasc = Quantity("Nano_Electron_deltaEtaSC")
el_dxy = Quantity("Nano_Electron_dxy")
el_dz = Quantity("Nano_Electron_dz")
el_iso = Quantity("Nano_Electron_pfRelIso03_all")
el_cutbasedid = Quantity("Nano_Electron_cutBased")
